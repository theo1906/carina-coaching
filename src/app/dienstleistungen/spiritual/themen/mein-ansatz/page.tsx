      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-pink prose-lg max-w-none">
          ...
          <div className="bg-pink-50 p-6 rounded-xl my-8 border-l-4 border-pink-500">
            <h3 className="font-bold text-lg text-pink-800 mb-2">The theory of holes</h3>
          ...
          <div className="bg-purple-50 p-6 rounded-xl my-8 border-l-4 border-purple-500">
            <h3 className="font-bold text-lg text-purple-800 mb-2">Your journey of discovery and empowerment</h3>
            <p className="text-gray-700">
              Ich begleite dich darin, die Leere zu fühlen, die du nicht fühlen willst. Gemeinsam erforschen wir durch liebevolle "inquiry" (eine Methode im Coaching, die tiefe Selbstreflexions-Prozesse anstößt) die Gründe für diese Leere und nutzen sie dadurch wie eine Art Tür, die dich step by step zurück führt in deine Vollständigkeit, Präsenz und damit in deine ganze Kraft, die dich von innen heraus führt das zu leben was du fühlst und mutig dafür los zu gehen.
            </p>
          </div>
          
          <p className="text-gray-700 mb-6">
            Verkörperte Präsenz zu entwickeln, ist deshalb so wertvoll, weil sie dir mehr und mehr die Freiheit schenkt, bewusst wählen zu können, wie du dich verhalten möchtest in einer Situation, die dich triggert. Anstatt auf Autopilot zu schalten und aus nicht verarbeiteten Verletzungen aus deiner Vergangenheit heraus zu reagieren oder dich wie gelähmt zu fühlen und damit handlungsunfähig und ausgeliefert.
          </p>
          ...
          <p className="text-gray-700 mb-6">
            Auf dieser Entdeckungsreise zu dir selbst lernst du dich immer besser kennen. Das entspannt dich, dein Nervensystem und schenkt dir Frieden, Selbstsicherheit und Stabilität von innen heraus und mehr Freiheit für Kreation und Entfaltung im Außen.
          </p>
